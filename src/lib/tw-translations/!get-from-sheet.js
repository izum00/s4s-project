// unlike the home repo version, the filename prop is what key to use in generated-translations.json
// command format: node [path to this file] [...page name fragments] [language name]
// so ie node `./home/src/translations/\!get-from-sheet.js english en`
// or also `node ./\!get-from-sheet.js spanish spain es`

// replace with your api key, if your a pm dev than just ask gsa for a key
// alternatively you can set an env var for it, such as just putting the env
// in root and forgetting it exists
